...
public record ShippingInstructionSummaryTO(
    @NotBlank(message = "The attribute shippingInstructionReference is required.")
        @Size(
            max = 100,
            message = "The attribute shippingInstructionReference has a max size of 100.")
    ...
    @JsonAlias({"numberOfOriginals", "requestedNumberOfOriginals"}) Integer numberOfOriginals,
    @NotNull(message = "The boolean attribute isElectronic is required.") boolean isElectronic,
    @NotNull(message = "The boolean attribute isToOrder is required.") boolean isToOrder,
    boolean areChargesDisplayedOnOriginals,
    @Size(
            max = 250,
            message = "The attribute displayedNameForPlaceOfReceipt has a max size of 250.")
    ...
    @Size(
            max = 250,
            message = "The attribute displayedNameForPortOfDischarge has a max size of 250.")
        String displayedNameForPortOfDischarge,
    @Size(
            max = 250,
            message = "The attribute displayedNameForPlaceOfDelivery has a max size of 250.")
        String displayedNameForPlaceOfDelivery,
    List<
            @Size(
                max = 100,
                message = "The attribute carrierBookingReference has a max size of 100.")
            String>
