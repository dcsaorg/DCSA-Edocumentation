...
public record DFAStateInfo<S>(boolean validState, Set<S> successorStates) {
  ...
  public static <S extends Object> DFAStateInfo<S> unreachableState() {
    return (DFAStateInfo<S>) INVALID_STATE;
  }

  @SuppressWarnings("unchecked")
  public static <S extends Object> DFAStateInfo<S> terminalState() {
    return (DFAStateInfo<S>) FINAL_STATE;
  }

  public static <S extends Object> DFAStateInfo<S> successorStates(Set<S> s) {
